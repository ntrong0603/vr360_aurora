...
@section('title', 'Thêm nhu cầu liên hệ')
@section('content')
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title title-custom">THÊM MỚI NHU CẦU LIÊN HỆ</h3>
                </div>
                <!-- /.card-header -->
                <form class="form-horizontal form-brand" action="{{ route('enquiry.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
