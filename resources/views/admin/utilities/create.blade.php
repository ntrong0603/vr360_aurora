        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title title-custom">THÊM MỚI TIỆN ÍCH</h3>
                </div>
                <!-- /.card-header -->
                <form class="form-horizontal form-brand" action="{{ route('utilities.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2">Tên hotspot:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('name_hotspot') is-invalid @enderror" name="name_hotspot" value="{{old('name_hotspot')}}">
                                @error('name_hotspot')
                                <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
