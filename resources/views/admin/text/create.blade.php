...
@section('title', 'Thêm tiêu đề cố định')
@section('content')
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title title-custom">THÊM MỚI TIÊU ĐỀ</h3>
                </div>
                <!-- /.card-header -->
                <form class="form-horizontal form-brand" action="{{ route('text.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
