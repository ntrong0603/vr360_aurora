        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title title-custom">Quản lý cảnh VR</h3>
                </div>
                        ...
                        <form class="form-horizontal" action="" method="GET">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputName" class="col-sm-2 col-form-label">Nhập tên cảnh VR</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="name" id="inputName" placeholder="Nhập tên cảnh VR..." value="{{ Request::get('name') }}">
                                    </div>
                                    <div class="col-sm-7">
                    ...
                    <table class="table table-striped table-style">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('scene.edit', ['scene' => $data->id]) }}">
